...
## My skills:
✦ Python<br> <pre> • Machine Learning — PyTorch, TensorFlow, Keras, Scikitlearn, CatBoost, XGBoost<br> • Data Analysis — Pandas, NumPy, SciPy<br> • Data Visualization — Matplotlib, Plotly, Seaborn<br> • Jupyter Notebook, Google Colab<br></pre> ✦ Mathematics:<br> • Linear algebra<br> • Mathematical analysis<br> • Probability theory<br> • Mathematical statistics<br>✦ PostgreSQL, MySQL, SQLite <br>✦ Git, GitHub, GitLab<br>✦ English (B2)<br>✦ Soft Skills <br> • Communication<br> • Problem Solving<br> • Easy to learn <br> • Stress-resistant<br> • Creative<br>
